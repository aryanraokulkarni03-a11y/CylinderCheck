...
const AdSlot = ({ id = "top" }) => (
  <div style={{
    background: "#0d0d0d", border: "1px dashed #1e1e1e", borderRadius: 12,
                          ...
                          <div style={{
                            ...
                            <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
                              ...
                              <div>
                                ...
                                <div style={{
                                  fontSize: 11, color: "#333", marginTop: 12, borderTop: "1px solid #1e1e1e",
            ...
            {tab === "community" && (
              <div className="fu">
                ...
                <div className="g2">
                  ...
                  <div>
                    <div style={{
                      fontSize: 10, fontWeight: 700, color: "#444", letterSpacing: 1.8,
                  ...
                  <div>
                    <div style={card}>
                      <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 16 }}>
                        <span style={{
                          fontSize: 11, fontWeight: 700, color: "#22c55e", background: "#22c55e14",
                    ...
                    <div className="g3" style={{ marginBottom: 20 }}>
                      {[
                        ...
                        <div key={label} style={{ ...card, marginBottom: 0 }}>
                          ...
                          <div style={{
                            fontSize: 11, color: "#555", fontWeight: 600, letterSpacing: .8,
                            ...
                            <tbody>
                              {adminData.subscriptions.map((s) => (
                                <tr key={s.id}>
                                  ...
                                  <td style={{
                                    padding: "10px 12px", color: "#555", fontSize: 11,
                                    borderBottom: "1px solid #141414"
                                  }}>
