...
export default function LiquidGlassBtn({
  ...
  const commonProps = {
    className: `glass-btn relative overflow-hidden flex items-center justify-center gap-2 min-h-[52px] px-7 rounded-md font-body text-[15px] font-semibold text-[var(--accent-pop)] cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed ${disabled ? 'opacity-50 cursor-not-allowed' : ''} ${className}`,
